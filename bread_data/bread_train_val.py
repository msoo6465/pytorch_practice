...
if __name__ == '__main__':
    data_dir = '~/PycharmProjects/lib/pytorch_practice/bread_data/bread'
    train_dir = '~/PycharmProjects/lib/pytorch_practice/bread_data/train'
    val_dir = '~/PycharmProjects/lib/pytorch_practice/bread_data/val'
